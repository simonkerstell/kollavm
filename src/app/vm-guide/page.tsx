...
import { BookOpen, Home, MapPin, HelpCircle } from "lucide-react";
...
const sections = [
  ...
  },
  {
    ...
    icon: MapPin,
    label: "Restauranger",
    desc: "Hitta de bästa sportbarerna och restaurangerna att se VM-matcherna på i Stockholm, Göteborg och Malmö.",
  },
  {
    href: "/faq",
    icon: HelpCircle,
