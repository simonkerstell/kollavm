    ...
    <html lang="sv">
      <head>
        <Script id="gtm" strategy="afterInteractive">{`
          ...
          })(window,document,'script','dataLayer','GTM-TMXG9JTS');
        `}</Script>
      </head>
      <body className={inter.className}>
        <noscript>
          <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TMXG9JTS" height="0" width="0" style={{display:"none",visibility:"hidden"}} />
        </noscript>
        <AuthProvider>
          <Navbar />
          <main>{children}</main>
